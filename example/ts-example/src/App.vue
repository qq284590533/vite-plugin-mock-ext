...
export default defineComponent({
  ...
  setup() {
    ...
    const getRoleById = () => {
      ...
      axios.get(mockUrl+'/api/getRoleById', { params: { id: 2 } }).then(({ data }) => {
    ...
    const testRestful = () => {
      ...
      axios.get(mockUrl+'/api/testRestful/1').then(({ data }) => {
    ...
    const testPostRestful = () => {
      ...
      axios.post(mockUrl+'/api/testRestful/1').then(({ data }) => {
